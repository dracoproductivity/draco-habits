      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-sm text-muted-foreground min-w-[80px] text-center">{formatViewDate()}</span>
            <button
              onClick={() => navigateDay(1)}
              className="p-1 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/30 transition-all"
            >
        ...
        <div className="flex items-center gap-4">
          {/* Progress percentages on the right */}
          <div className="flex items-center gap-3 text-sm">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-semibold text-foreground">{weeklyProgress}%</span>
            </div>
          </div>
          <button
